#ifndef P101_MODULE_MAP_CLI_H
#define P101_MODULE_MAP_CLI_H
...
_Noreturn void p101_module_map_usage(const struct p101_env *env, struct p101_error *err, const char *program_name, int exit_code, const char *message);

#endif    // P101_MODULE_MAP_CLI_H
